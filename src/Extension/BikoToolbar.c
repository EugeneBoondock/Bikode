...
*
* BikoToolbar.c
*   Custom owner-drawn toolbar with full dark mode support.
...
#define BTB_HEIGHT          34
#define BTB_BTN_WIDTH       30
#define BTB_SEP_WIDTH       10
#define BTB_ICON_SZ         14

// Dark
#define BTB_DK_BG           RGB(24, 24, 24)
#define BTB_DK_HOVER        RGB(50, 50, 55)
#define BTB_DK_PRESS        RGB(65, 65, 72)
#define BTB_DK_CHECK        RGB(55, 55, 62)
#define BTB_DK_ICON         RGB(190, 190, 195)
#define BTB_DK_DISABLED     RGB(75, 75, 80)
#define BTB_DK_SEP          RGB(55, 55, 60)
#define BTB_DK_ACCENT       RGB(99, 102, 241)
...
// Command IDs (matching resource.h / AICommands.h)
...
//=============================================================================
// GDI icon drawing  (14x14 viewport at ox,oy)
//=============================================================================
...
static void BTB_DrawIcon(HDC hdc, IconType icon, int ox, int oy, COLORREF clr)
{
    ...
    {
    case ICON_NEW:
        L2(hdc, ox+3, oy+0, ox+9, oy+0);
        L2(hdc, ox+9, oy+0, ox+12, oy+3);
        L2(hdc, ox+12, oy+3, ox+12, oy+13);
        L2(hdc, ox+12, oy+13, ox+3, oy+13);
        L2(hdc, ox+3, oy+13, ox+3, oy+0);
        L2(hdc, ox+9, oy+0, ox+9, oy+3);
        L2(hdc, ox+9, oy+3, ox+12, oy+3);
        break;

    case ICON_OPEN:
        L2(hdc, ox+1, oy+3, ox+6, oy+3);
        L2(hdc, ox+6, oy+3, ox+7, oy+5);
        L2(hdc, ox+7, oy+5, ox+12, oy+5);
        L2(hdc, ox+1, oy+3, ox+1, oy+12);
        L2(hdc, ox+1, oy+12, ox+12, oy+12);
        L2(hdc, ox+12, oy+12, ox+13, oy+6);
        L2(hdc, ox+13, oy+6, ox+4, oy+6);
        L2(hdc, ox+4, oy+6, ox+1, oy+12);
        break;

    case ICON_SAVE:
        Rectangle(hdc, ox+2, oy+1, ox+13, oy+14);
        L2(hdc, ox+4, oy+1, ox+4, oy+5);
        L2(hdc, ox+4, oy+5, ox+10, oy+5);
        L2(hdc, ox+10, oy+5, ox+10, oy+1);
        Rectangle(hdc, ox+5, oy+8, ox+10, oy+12);
        break;

    case ICON_UNDO:
        L2(hdc, ox+2, oy+5, ox+6, oy+1);
        L2(hdc, ox+2, oy+5, ox+6, oy+9);
        L2(hdc, ox+2, oy+5, ox+9, oy+5);
        L2(hdc, ox+9, oy+5, ox+12, oy+8);
        L2(hdc, ox+12, oy+8, ox+12, oy+12);
        L2(hdc, ox+12, oy+12, ox+7, oy+12);
        break;

    case ICON_REDO:
        L2(hdc, ox+12, oy+5, ox+8, oy+1);
        L2(hdc, ox+12, oy+5, ox+8, oy+9);
        L2(hdc, ox+12, oy+5, ox+5, oy+5);
        L2(hdc, ox+5, oy+5, ox+2, oy+8);
        L2(hdc, ox+2, oy+8, ox+2, oy+12);
        L2(hdc, ox+2, oy+12, ox+7, oy+12);
        break;

    case ICON_CUT:
        L2(hdc, ox+4, oy+0, ox+9, oy+7);
        L2(hdc, ox+10, oy+0, ox+5, oy+7);
        Ellipse(hdc, ox+1, oy+8, ox+7, oy+14);
        Ellipse(hdc, ox+7, oy+8, ox+13, oy+14);
        break;

    case ICON_COPY:
        Rectangle(hdc, ox+0, oy+3, ox+9, oy+13);
        L2(hdc, ox+4, oy+0, ox+13, oy+0);
        L2(hdc, ox+13, oy+0, ox+13, oy+10);
        L2(hdc, ox+9, oy+10, ox+13, oy+10);
        L2(hdc, ox+4, oy+0, ox+4, oy+3);
        break;

    case ICON_PASTE:
        Rectangle(hdc, ox+2, oy+3, ox+12, oy+14);
        Rectangle(hdc, ox+5, oy+0, ox+9, oy+4);
        L2(hdc, ox+4, oy+7, ox+10, oy+7);
        L2(hdc, ox+4, oy+9, ox+10, oy+9);
        L2(hdc, ox+4, oy+11, ox+8, oy+11);
        break;
    ...
    case ICON_REPLACE:
        Ellipse(hdc, ox+1, oy+1, ox+9, oy+9);
        L2(hdc, ox+8, oy+8, ox+10, oy+10);
        // arrows
        L2(hdc, ox+7, oy+11, ox+13, oy+11);
        L2(hdc, ox+11, oy+9, ox+13, oy+11);
        L2(hdc, ox+13, oy+11, ox+11, oy+13);
        break;

    case ICON_PRINT:
        Rectangle(hdc, ox+1, oy+4, ox+13, oy+11);
        Rectangle(hdc, ox+3, oy+0, ox+11, oy+5);
        Rectangle(hdc, ox+3, oy+9, ox+11, oy+14);
        {
            HBRUSH dot = CreateSolidBrush(clr);
            RECT rd = {ox+10, oy+6, ox+12, oy+8};
            FillRect(hdc, &rd, dot);
            DeleteObject(dot);
        }
        break;
    ...
    case ICON_WRAP:
        L2(hdc, ox+1, oy+2, ox+12, oy+2);
        L2(hdc, ox+12, oy+2, ox+12, oy+7);
        L2(hdc, ox+12, oy+7, ox+4, oy+7);
        L2(hdc, ox+4, oy+7, ox+6, oy+5);
        L2(hdc, ox+4, oy+7, ox+6, oy+9);
        L2(hdc, ox+1, oy+12, ox+12, oy+12);
        break;

    case ICON_ZOOMIN:
        Ellipse(hdc, ox+1, oy+1, ox+10, oy+10);
        L2(hdc, ox+5, oy+3, ox+5, oy+8);
        L2(hdc, ox+3, oy+5, ox+8, oy+5);
        {
    ...
    case ICON_BIKO: {
        POINT pts[] = {
            {ox+1, oy+2}, {ox+3, oy+0}, {ox+11, oy+0}, {ox+13, oy+2},
            {ox+13, oy+7}, {ox+11, oy+9}, {ox+7, oy+9},
            {ox+5, oy+12}, {ox+5, oy+9}, {ox+3, oy+9},
            {ox+1, oy+7}, {ox+1, oy+2}
        };
        Polyline(hdc, pts, 12);
        HBRUSH db = CreateSolidBrush(clr);
        RECT d1={ox+4,oy+4,ox+6,oy+6};
        RECT d2={ox+7,oy+4,ox+9,oy+6};
        RECT d3={ox+10,oy+4,ox+12,oy+6};
        FillRect(hdc, &d1, db);
        FillRect(hdc, &d2, db);
        FillRect(hdc, &d3, db);
        DeleteObject(db);
...
static void Paint(HWND hwnd, HDC hdc)
{
    ...
    COLORREF cSep = dk ? BTB_DK_SEP     : BTB_LT_SEP;
    ...
    for (int i = 0; i < (int)BTN_COUNT; i++)
    {
        ...
        if (s_btns[i].cmdId == 0) {
            ...
            HPEN sp = CreatePen(PS_SOLID, 1, cSep);
        ...
        COLORREF btnBg = cBg;
        if (i == s_press)            btnBg = cPrs;
        else if (i == s_hover)       btnBg = cHov;
        else if (s_btns[i].checked)  btnBg = cChk;

        if (btnBg != cBg) {
            HBRUSH hb = CreateSolidBrush(btnBg);
            HPEN hp = CreatePen(PS_SOLID, 1, btnBg);
            HBRUSH xb = (HBRUSH)SelectObject(mem, hb);
            HPEN xp = (HPEN)SelectObject(mem, hp);
            RoundRect(mem, br.left, br.top, br.right, br.bottom, 6, 6);
            SelectObject(mem, xb);
            SelectObject(mem, xp);
            DeleteObject(hb);
            DeleteObject(hp);
        ...
        COLORREF fg = s_btns[i].enabled ? cIco : cDis;
        if (s_btns[i].icon == ICON_BIKO && s_btns[i].enabled)
            fg = cAcc;
